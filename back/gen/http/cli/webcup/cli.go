...
import (
	...
	"net/http"
	"os"
	authc "webcup/back/gen/http/auth/client"
	contactsc "webcup/back/gen/http/contacts/client"
	filesc "webcup/back/gen/http/files/client"
	jwttokenc "webcup/back/gen/http/jwt_token/client"
	oauthc "webcup/back/gen/http/o_auth/client"
	publicusersc "webcup/back/gen/http/public_users/client"
	usersc "webcup/back/gen/http/users/client"

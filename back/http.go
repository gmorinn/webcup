...
import (
	...
	"sync"
	"time"
	filesclient "webcup/back/api"
	"webcup/back/config"
	authsvr "webcup/back/gen/http/auth/server"
	contactssvr "webcup/back/gen/http/contacts/server"
	fileapisvr "webcup/back/gen/http/fileapi/server"
	filessvr "webcup/back/gen/http/files/server"
	jwttokensvr "webcup/back/gen/http/jwt_token/server"
	oauthsvr "webcup/back/gen/http/o_auth/server"
	openapisvr "webcup/back/gen/http/openapi/server"
	public_userssvr "webcup/back/gen/http/public_users/server"
	userssvr "webcup/back/gen/http/users/server"
